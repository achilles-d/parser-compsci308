...
public class MainTester {
    ...
    public static void main (String[] args) throws NoSuchMethodException, InstantiationException, IllegalAccessException, InvocationTargetException, ClassNotFoundException, ExecutionException {
        ...
        TurtleController ct= new TurtleController();
        ct.createNewTurtle(0);
        CommandParser lang = new CommandParser(ch, uh, ct);
...
//               "pinwheel\n";
        ...
        //String userInput= "tell [ 1 ] fd 100 rt 90 tell [ 2 ]  rt 90";
        ...
        //String userInput="tell [ 2 ] fd 40 rt 90";
